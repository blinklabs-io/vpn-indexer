...
require (
	github.com/Salvionied/apollo v1.1.2-0.20250710190635-dc99198b769d // go get github.com/Salvionied/apollo@pv3
...
//replace github.com/Salvionied/apollo => ./internal/apollo
